...
const navItem: Array<{ name: string; to?: string; type: string; href?: string }> = [
...
export const Navbar = () => {
    ...
    useEffect(() => {
        function handleClickOutside(event: MouseEvent) {
            if (userMenuRefDesktop.current && !userMenuRefDesktop.current.contains(event.target as Node)) {
