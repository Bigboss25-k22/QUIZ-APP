...
2. Configure the database connection in `quiz-api/.env`:
...
Configure JWT settings in `quiz-api/.env`:
...
Update the API base URL in `quiz-web/src/lib/axiosInstance.js` to point to your backend server.
